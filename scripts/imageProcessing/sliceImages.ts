...
function cropSheet(
  ...
  cropToSubSheet(
    sheet,
    13 * universalFrameSize,
    4 * universalFrameSize,
    0,
    16 * universalFrameSize,
    "shoot",
    sheetHeight,
    isMasterSheet,
  );
  ...
  result = cropToSubSheet(
    sheet,
    2 * universalFrameSize,
    4 * universalFrameSize,
    0,
    22 * universalFrameSize,
    "idle",
    sheetHeight,
    isMasterSheet,
  );
  ...
  result = cropToSubSheet(
    sheet,
    5 * universalFrameSize,
    4 * universalFrameSize,
    0,
    26 * universalFrameSize,
    "jump",
    sheetHeight,
    isMasterSheet,
  );
  ...
  result = cropToSubSheet(
    sheet,
    3 * universalFrameSize,
    4 * universalFrameSize,
    0,
    30 * universalFrameSize,
    "sit",
    sheetHeight,
    isMasterSheet,
  );
